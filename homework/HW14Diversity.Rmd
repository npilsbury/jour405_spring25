...
View(md_cities)
```
Aspen Hill and Edgewood are two cities that stuck out to me as diverse. College Park also seemed fairly diverse. Bel Air South and Bel Air North's lack of diversity stuck out to me as well. 
...
Summerfield has the highest race probability- it had a race probability of about 87%. I think that this is because about 93% of Summerfield's population is Black, so there is a high percentage that two randomly selected people from Summerfield will be Black. 
```{r race-prob}
md_cities <- md_cities |>
  mutate(
...
The cities that have the lowest Hisp_prob are Chillum, East Riverdale and Wheaton. All three of these cities have a relatively low race probabiltiy, with percentages ranging from about 18% to about 29%. They also all have a Hispanic population between about 42% and 57%. Each of the cities seem fairly diverse. 
...
The top three most diverse cities are Langley Park, Wheaton and Adelphi. The three cities are located near each other, about 8-10 miles from Washington D.C. The least diverse city is Lake Shore, which is located in Anne Arundel County along the Chesapeake Bay. It is about 22 miles from Baltimore City.
...
Headline: Maryland cities near Washington D.C. are more diverse, data shows

Lede: Langley Park, Wheaton and Adelphi, which are all within 10 miles of Washington, D.C., are the most diverse cities in Maryland, according to recent data. 

How I would report: I would talk to the mayor of each of the cities to ask them what factors they believe contribute to a diverse community and how they believe that their community benefits from the diversity. I would also reach out to see if there are any cultural organizations that are prominent in the town and ask them similar questions about the value of diversity. I think it would also be interesting to talk to teachers to see how diversity helps to shape childrens' learning. 
When I report the data, I think that explaining what high/low values mean in terms of diversity and how the chance of randomly selecting two people with the same background plays into the value. I think USA Today did a good job, but I would eliminate putting into the reader's perspective, as that may be confusing since readers may begin to think about themselves and running into someone of their own race as opposed to randomly selecting two people from the area. 
