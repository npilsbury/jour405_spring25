...
I think that the differences are somewhat meaningful because some of the proportions are being adjusted, such as with the F category. The expected frequency predictd 25% more F than the observed category had. Similarly, the expected category predicted 20% fewer As than observed. Overall, I think the differences are meaningful enough to say that there are other factors affecting the grade distribution. 
...
Yes, we do reject the null hypothesis because the chi-square statistic was 11.667, which is greater than teh critical value of 9.49. This means that the expected grades are not consistent with the observed grades. 
...
I think that there are notable discrepancies in both the A and F category, which A being underestimated and F being overestimated. The other categories were off, but do not appear as proportionally misjudged. It seems the instructor made the exam or class less difficult than they thought. I would also ask what they are basing the expected frequencies off of and why they think the results are different- teaching style? smarter students? cheating? 
