...
Is this a useful model, based on what you've seen? Why?
 ...
 I think that the model is useful because it tells us things about the accuracy of the predication. It lets us know that the highest and lowest residuals are around 4, which is large since there is only 11 games. It also lets us know that the average residual is around 2. The model also tells us which of the aspects we are considering have the most impact. For example, the model helped us to determine that the yards gained does not contribute much to determining wins.
 The model also has an overall statistically significant p-value, which makes the findings more credible.
...
Out of these factors, points scored has the most impact on wins. It had the largest correlation coefficient (about 0.71), and also had the largest circle on the correlation matrix. Takeaways' correlation coefficient was less (0.57), and yards gained had the lowest (0.44).
I think that we should consider taking out yards gained because it was heavily correlated with points scored in the correlation test. It also was not statistically significant in the model we ran previously, as it had a p-value of 0.34.
...
I could use this model to cover a team or a game by saying that points scored has the most impact on a team's amount of wins compared to takeaways and yards gained. I would also compare different teams number of points scored and number of wins as examples to furhter prove my point. If I were to do a story on this, I would compare more factors like fumbles and sacks.
