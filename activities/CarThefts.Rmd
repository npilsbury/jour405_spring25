...
The distribution is skewed to the right, as more of the data is within one standard deviation above the mean (to the right). Less data is within one standard deviation below the mean. 
