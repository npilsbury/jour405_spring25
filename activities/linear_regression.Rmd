...
There is a moderately positive relationship between FARMS percentage and math test scores, meaning that schools with higher percentages of students on FARMS tend to do have a higher percent of students who exceed math expectations. The reltionship is very weak, as the plots are very spread out and many are not close to the line of best fit. 
...
I think the model is useful because it tells us that the FARMS percentage does not account for the percent of students who exceeded expectations on math scores. This is important to know, as otherwise it may be reported that there is a positive relationship between the two. 
...
There were more negative residuals than positive ones, with the top three absolute residuals being about 46, 39 and 31.
...
I think I would pitch a story saying that there is not evidence of a clear relationship between the two, and bring in data and quotes from the school board member. This would mean that both the claim that schools with more students on FARMS do better, and the claim of the school baord member. 
