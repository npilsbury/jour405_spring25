...
The latter set is less than the expected frequency for the 5 star and 3 star reviews, and is more than expected for the 4 star, 2 star, and 1 star reviews. The most significant difference is the expected frequency of 160 5 star reviews and the observed frequency of 145 5 star reviews. 
...
I would reject the null hypothesis because the chi-square statistic (9.95) is larger than the critical value (9.48). Rejecting the null hypothesis is rejecting the idea that the observed frequencies are consistent with the expected frequencies. It also means that we accept the alternative hypothesis of the observed frequencies being significantly different than the expected frequencies. 
